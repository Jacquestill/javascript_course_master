...
// console.log(dolphins1, koalas1, dolphins2, koalas2);

// function checkWinner(dolphinAverage, koalaAverage) {
//     if (dolphinAverage >= (koalaAverage * 2)) {
//         console.log(`Dolphins wins (${dolphinAverage} vs. ${koalaAverage})`);
//     } else if (koalaAverage >= (dolphinAverage * 2)) {
//         console.log(`Koalas wins (${koalaAverage} vs. ${dolphinAverage})`);
//     } else {
//         console.log("No team wins!");
//     }
// }

// const winnerDetermine1 = checkWinner(dolphins1, koalas1);
// const winnerDetermine2 = checkWinner(dolphins2, koalas2);
...
(you can check out the code from first tip calculator challenge if you
 need to). Use the function type you like the most. Test the
