...
//   const answer = Number(prompt('0: JavaScript \n1: Python \n2: Rust \n3: C++'));
//   //   console.log(answer);
//   let [JavaScript, Python, Rust, C] = [...poll.answer];
//   if (answer === 0) {
//     JavaScript++;
//   } else if (answer === 1) {
//     Python++;
...
//     C++;
//   }
//   //   console.log(JavaScript, Python, Rust, C);
//   poll.answer = [JavaScript, Python, Rust, C];
//   displayResults(poll.answer);
// };
